...
class PNGUtilTest(unittest.TestCase):  # pylint: disable-msg=R0904
    ...
    def test_chunks(self):
        ...
        self.assertEqual([[1], [2], [3]], list(png_util.chunks([1, 2, 3], 1)))
        self.assertEqual([[1, 2], [3, 4]], list(png_util.chunks([1, 2, 3, 4], 2)))

    def test_color_to_plane_bits_depth_0(self):
        """call color_to_plane_bits() with depth 0"""
        self.assertEqual([], png_util.color_to_plane_bits(0, 0))

    def test_color_to_plane_bits_depth_1(self):
        """call color_to_plane_bits() with depth 1"""
        self.assertEqual([0], png_util.color_to_plane_bits(0, 1))
        self.assertEqual([1], png_util.color_to_plane_bits(1, 1))

    def test_color_to_plane_bits_depth_2(self):
        """call color_to_plane_bits() with depth 2"""
        self.assertEqual([0, 0], png_util.color_to_plane_bits(0, 2))
        self.assertEqual([1, 0], png_util.color_to_plane_bits(1, 2))
        self.assertEqual([0, 1], png_util.color_to_plane_bits(2, 2))
        self.assertEqual([1, 1], png_util.color_to_plane_bits(3, 2))
    ...
    def test_extract_planes_1_2by16_all_1(self):
        ...
        planes, map_words_per_row = png_util.extract_planes(im, 1, False)
        self.assertEqual(1, map_words_per_row)
        self.assertEqual([[65535, 65535]], planes)
    ...
    def test_extract_planes_1_2by32_all_1(self):
        ...
        planes, map_words_per_row = png_util.extract_planes(im, 1, False)
        self.assertEqual(2, map_words_per_row)
        self.assertEqual([[65535, 0, 65535, 0]], planes)
